                     ...
                     <div class="body">
                        ...
                        <div class="checkbox">
                         ...
                         <div class="row clearfix"> 
                                  ...
                                  <div class="col-lg-6 col-md-6 col-sm-8">
                                    <button tabindex="55" onclick ="tg();" class="btn btn-raised btn-success btn-lg btn-block btn-round waves-effect"><h6>Print Form </h6> </button>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-8">
                                    <button type="reset" onclick = " window.location='welcome.php'"class="btn btn-raised btn-warning btn-lg btn-block btn-round waves-effect"><h6>Back </h6> </button>
                                </div>   
